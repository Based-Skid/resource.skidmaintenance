...
#                                                                              #
#                                                                              #
#      Contains Automatic Maintence addon Code by Sufacingx                    #
#                     http://aftermathwizard.net/                              #
...
addon_id = 'resource.skidmaintenance'
ADDON = xbmcaddon.Addon(id=addon_id)
FANART = xbmc.translatePath(os.path.join('special://home/addons/' + addon_id , 'fanart.jpg'))
ICON = xbmc.translatePath(os.path.join('special://home/addons/' + addon_id, 'icon.png'))
ART = xbmc.translatePath(os.path.join('special://home/addons/' + addon_id + 'fanart.jpg'))
VERSION = "3.0.0"
PATH = "skid"            
BASE = "maintenance"
